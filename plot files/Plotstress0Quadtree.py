...
def Plotstress0Quadtree(DICpara = None,ResultStrain = None,coordinatesFEM = None,elementsFEM = None): 
...
#########################################################
    figure
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_sxx,'NoEdgeColor')
    ...
    colormap('jet')
    set(gcf,'color','w')
    if np.amax(coordinatesFEM(:,1)) < um2px * 200:
        set(gca,'XTick',[])
    
    if np.amax(coordinatesFEM(:,2)) < um2px * 200:
        set(gca,'YTick',[])
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_sxy,'NoEdgeColor')
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_syy,'NoEdgeColor')
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_principal_max_xyplane,'NoEdgeColor')
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_principal_min_xyplane,'NoEdgeColor')
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_maxshear_xyplane,'NoEdgeColor')
...
#########################################################
    ...
    show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEM,stress_maxshear_xyz3d,'NoEdgeColor')
