...
def PlotstressQuadtree(DICpara = None,ResultStrain = None,coordinatesFEM = None,elementsFEM = None,CurrentImg = None): 
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_sxx,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_sxy,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_syy,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_principal_max_xyplane,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_principal_min_xyplane,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_maxshear_xyplane,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_maxshear_xyz3d,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,stress_vonMises,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
