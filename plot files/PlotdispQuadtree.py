...
def PlotdispQuadtree(U = None,coordinatesFEM = None,elementsFEM = None,CurrentImg = None,DICpara = None): 
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,disp_u,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
...
#########################################################
    ...
    hold('on')
    ax2 = axes
    h2 = show([],elementsFEM(:,np.arange(1,4+1)),coordinatesFEMWorldDef / um2px,disp_v,'NoEdgeColor')
    set(gca,'fontSize',18)
    view(2)
    box('on')
    plt.axis('equal')
