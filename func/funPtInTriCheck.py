...
def funPtInTriCheck(TriNodeCoord = None,PtToCheckCoord = None): 
...
# ###############################################################
    ...
    point1x = TriNodeCoord(1,1)
    point1y = TriNodeCoord(1,2)
    point2x = TriNodeCoord(2,1)
    point2y = TriNodeCoord(2,2)
    point3x = TriNodeCoord(3,1)
    point3y = TriNodeCoord(3,2)
    pointOfx = PtToCheckCoord(:,1)
    pointOfy = PtToCheckCoord(:,2)
    ##
    p1x = pointOfx
    p1y = pointOfy
    p2x = point1x
    ...
    p3x = point2x
    p3y = point2y
    b1 = np.sign((p1x - p3x) * (p2y - p3y) - (p2x - p3x) * (p1y - p3y))
    p1x = pointOfx
    p1y = pointOfy
    p2x = point2x
    p2y = point2y
    p3x = point3x
    p3y = point3y
    b2 = np.sign((p1x - p3x) * (p2y - p3y) - (p2x - p3x) * (p1y - p3y))
    p1x = pointOfx
    p1y = pointOfy
    p2x = point3x
    p2y = point3y
    p3x = point1x
    p3y = point1y
    b3 = np.sign((p1x - p3x) * (p2y - p3y) - (p2x - p3x) * (p1y - p3y))
    ptInTriOrNot = 1 - logical(np.sign(np.abs(b1 - b2) + np.abs(b2 - b3)))
